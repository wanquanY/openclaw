...
const CORE_SECRET_TARGET_REGISTRY: SecretTargetRegistryEntry[] = [
  ...
  {
    id: "agents.defaults.skillSettings.*.apiKey",
    targetType: "agents.defaults.skillSettings.apiKey",
    targetTypeAliases: ["agents.defaults.skillSettings.*.apiKey"],
    configFile: "openclaw.json",
    pathPattern: "agents.defaults.skillSettings.*.apiKey",
    secretShape: SECRET_INPUT_SHAPE,
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
  ...
  {
    id: "agents.list[].skillSettings.*.apiKey",
    targetType: "agents.list.skillSettings.apiKey",
    targetTypeAliases: ["agents.list[].skillSettings.*.apiKey"],
    configFile: "openclaw.json",
    pathPattern: "agents.list[].skillSettings.*.apiKey",
    secretShape: SECRET_INPUT_SHAPE,
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
