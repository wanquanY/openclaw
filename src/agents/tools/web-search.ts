...
function freshnessToPerplexityRecency(freshness: string | undefined): string | undefined {
  ...
  return FRESHNESS_TO_RECENCY[freshness] ?? (PERPLEXITY_RECENCY_VALUES.has(freshness) ? freshness : undefined);
}
        ...
        : params.provider === "gemini"
          ...
          : params.provider === "kimi"
            ...
            : params.provider === "serper"
              ? (params.serperBaseUrl ?? DEFAULT_SERPER_BASE_URL)
            : "";
    ...
    execute: async (_toolCallId, args) => {
      ...
      if (
        ...
        return jsonResult({
          ...
          message: `freshness filtering is not supported by the ${provider} provider. Only Brave, Perplexity, and Serper support freshness.`,
          docs: "https://docs.openclaw.ai/tools/web",
        });
      }
