...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.web.search.perplexity.apiKey": "Perplexity Search API Key",
  "tools.web.search.perplexity.baseUrl": "Perplexity Search Base URL",
  "tools.web.search.perplexity.model": "Perplexity Search Model",
  "tools.web.search.serper.apiKey": "Serper Search API Key",
  "tools.web.search.serper.baseUrl": "Serper Search Base URL",
  ...
  "agents.defaults.hostProductIdentity": "Host Product Identity",
  "agents.defaults.hostProductIdentity.productId": "Product ID",
  "agents.defaults.hostProductIdentity.productName": "Product Name",
  "agents.defaults.hostProductIdentity.assistantRole": "Assistant Role",
  "agents.defaults.hostProductIdentity.userFacingRuntimeName": "User-Facing Runtime Name",
  "agents.defaults.hostProductIdentity.internalRuntimeName": "Internal Runtime Name",
  "agents.defaults.hostProductIdentity.internalRuntimeVisibility": "Internal Runtime Visibility",
