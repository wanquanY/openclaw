...
export const FIELD_HELP: Record<string, string> = {
  ...
  "tools.web.search.provider":
    'Search provider id (for example "brave", "serper", "perplexity", "grok", "gemini", or "kimi"). Auto-detected from available API keys if omitted.',
  ...
  "tools.web.search.serper.baseUrl":
    "Serper base URL override (default: https://google.serper.dev).",
